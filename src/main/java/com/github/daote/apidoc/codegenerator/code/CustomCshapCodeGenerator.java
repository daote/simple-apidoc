...
public class CustomCshapCodeGenerator {
    ...
    public static String generateNodeCode(ResponseNode respNode) throws IOException {
        ...
        for (FieldModel entryFieldModel : entryFields) {
            stringBuilder.append("\tpublic ")
                    .append(entryFieldModel.getFieldType().contains("[")?"List<"+entryFieldModel.getFieldType().split("\\[")[0]+">":entryFieldModel.getCshapFieldType())
                    .append(" ")
